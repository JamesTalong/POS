...
import AddCategoriesThree from "./AddCategoriesThree"; // Assuming this is a valid path
...
const AllCategoriesThree = () => {
  ...
  const deleteCategoryThree = async (id) => {
    ...
    const confirmDelete = window.confirm(
      "Are you sure you want to delete this category?" // More specific message
    );
    ...
    try {
      ...
      toast.success("Category Successfully Deleted!"); // More specific message
      fetchData(); // Refresh data after deletion
    } catch (error) {
      console.error("Error deleting category:", error); // Consistent error logging
      toast.error("Failed to delete category."); // Consistent error message
    }
  };
  ...
  const totalPages = Math.ceil(
    filteredCategoriesThree.length / categoriesThreePerPage
  );
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {currentCategoriesThree.length === 0 && !loading ? (
                  <tr>
                    <td
                      colSpan="2"
