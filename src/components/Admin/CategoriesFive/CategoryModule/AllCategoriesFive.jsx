...
import AddCategoriesFive from "../CategoryModule/AddCategoriesFive"; // Assuming this is a valid path
...
const AllCategoriesFive = () => {
  ...
  const deleteCategoryFive = async (id) => {
    ...
    // Moved the confirm dialog to *before* the API call
  ...
  const totalPages = Math.ceil(
    filteredCategoriesFive.length / categoriesFivePerPage
  );
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {currentCategoriesFive.length === 0 && !loading ? (
                  <tr>
                    <td
                      colSpan="2"
