...
import AddCategoriesTwo from "../CategoryModule/AddCategoriesTwo"; // Assuming this is a valid path
...
const AllCategoriesTwo = () => {
  ...
  const totalPages = Math.ceil(
    filteredCategoriesTwo.length / categoriesTwoPerPage
  );
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {currentCategoriesTwo.length === 0 && !loading ? (
                  <tr>
                    <td
                      colSpan="2"
